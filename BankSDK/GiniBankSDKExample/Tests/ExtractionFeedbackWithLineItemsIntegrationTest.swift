//
//  ExtractionFeedbackWithLineItemsIntegrationTest.swift
//  GiniCaptureSDKExampleTests
//
//  Created by David Vizaknai on 20.12.2022.
...
class ExtractionFeedbackWithLineItemsIntegrationTest: XCTestCase {
    ...
    func testSendExtractionFeedback() {
        ...
        self.getExtractionsFromGiniBankSDK(delegate: CaptureResultsDelegateForExtractionsFeedbackTest(integrationTest: self, expect: expect))
    ...
    class CaptureResultsDelegateForExtractionsFeedbackTest: GiniCaptureResultsDelegate {
        ...
        let integrationTest: ExtractionFeedbackWithLineItemsIntegrationTest
        let expect: XCTestExpectation

        init(integrationTest: ExtractionFeedbackWithLineItemsIntegrationTest, expect: XCTestExpectation) {
