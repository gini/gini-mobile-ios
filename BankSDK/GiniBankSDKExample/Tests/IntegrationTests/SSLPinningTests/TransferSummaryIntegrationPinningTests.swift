//
//  TransferSummaryIntegrationPinningTests.swift
//
...
class TransferSummaryIntegrationPinningTests: BaseIntegrationTest {
   ...
   override func setUp() {
    ...
    class CaptureResultsDelegateForTransferSummaryTest: GiniCaptureResultsDelegate {
        let testCase: TransferSummaryIntegrationPinningTests
        let mockedInvoiceResultName: String
        let mockedInvoiceResultAfterFeedbackName: String
        let expect: XCTestExpectation

        init(testCase: TransferSummaryIntegrationPinningTests,
