...
#
# Builds, uploads, and runs the core UI smoke tests on BrowserStack.
# Suites covered:
#
...
# ── Media files ────────────────────────────────────────────────────────────────
TEST_IMAGE_FILE="$SAMPLES_DIR/test_image.png"  # → Photos library (used by GiniReviewScreenUITests via uploadLatestPhotoFromGallery)
...
upload_media TEST_IMAGE_URL "$TEST_IMAGE_FILE" "TestImage" "test_image.png"
...
echo "  test_image.png:  $TEST_IMAGE_URL"
