...
| `bs_run_all.sh` | every scenario above — builds/uploads once, triggers one build per scenario, named `<scenario>_<release>` (e.g. `smoke_journeys_4.5.0`, version taken from `BS_PROJECT`) | all media files |
