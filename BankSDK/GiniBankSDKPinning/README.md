...
In order to run [the example app](https://github.com/gini/gini-mobile-ios/tree/GiniBankSDK%3B3.1.3/BankSDK/GiniBankSDKPinningExample), clone the repo ,open the project file and Resolve Package Versions in Xcode `File->Packages->Resolve Package Versions`.
