...
enum GiniImages: String {
    ...
    case transactionDocOptionsIcon = "attachment_options_icon"
    case transactionDocImageIcon = "attachment_image_icon"
    case transactionDocDocumentIcon = "attachment_document_icon"
