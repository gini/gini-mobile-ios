...
//    }
    ...
    */
    ...
    /**
     This method determines whether the 'Skonto' should be applied based on the current edge case. Should be called only at screen launch
     */
    private func determineIsSkontoApplied() {
        switch edgeCase {
