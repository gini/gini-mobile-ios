...
public final class TransactionDocsDocumentPagesViewModel: DocumentPagesViewModelProtocol {
    ...
    var amountToPayString: String {
        let localizableText = transactionProceesed
