...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GiniInternalPaymentSDK", url: "https://github.com/gini/internal-payment-sdk-ios", .exact("2.2.0")),
        .package(name: "GiniUtilites", url: "https://github.com/gini/utilites-ios.git", .exact("2.0.3")),
    ],
    targets: [
