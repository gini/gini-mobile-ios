...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GiniInternalPaymentSDK", url: "https://github.com/gini/internal-payment-sdk-ios", .exact("2.3.2")),
        .package(name: "GiniUtilites", url: "https://github.com/gini/utilites-ios.git", .exact("2.1.1")),
    ],
    targets: [
