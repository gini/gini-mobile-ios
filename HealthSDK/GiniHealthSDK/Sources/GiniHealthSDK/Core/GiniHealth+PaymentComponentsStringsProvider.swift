...
extension GiniHealth: PaymentComponentsStringsProvider {
    public var paymentReviewContainerStrings: PaymentReviewContainerStrings {
        PaymentReviewContainerStrings(
            fieldPlaceholders: .init(
                recipient: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.recipient.placeholder",
                                                            comment: "placeholder text for recipient input field"),
                iban: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.iban.placeholder",
                                                       comment: "placeholder text for iban input field"),
                amount: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.amount.placeholder",
                                                         comment: "placeholder text for amount input field"),
                usage: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.usage.placeholder",
            ...
            fieldErrors: .init(
                ...
                iban: NSLocalizedStringPreferredFormat("gini.health.errors.failed.iban.non.empty.check",
                                                       comment: "iban failed non empty check"),
                amount: NSLocalizedStringPreferredFormat("gini.health.errors.failed.amount.non.empty.check",
                                                         comment: "amount failed non empty check"),
                purpose: NSLocalizedStringPreferredFormat("gini.health.errors.failed.purpose.non.empty.check",
                                                          comment: "purpose failed non empty check")
            ),
            bankSelectionAccessibility: .init(
                payInvoiceHint: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.banking.app.button.hint",
                                                                 comment: "Accessibility hint used for the pay invoice button default"),
                selectBankText: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.select.bank.label",
            ...
            keyboardDoneButtonTitle: NSLocalizedStringPreferredFormat("gini.health.reviewscreen.keyboard.done.button.title",
    ...
    public var paymentInfoStrings: PaymentInfoStrings {
        PaymentInfoStrings(
            giniLink: .init(
                websiteText: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.payment.info.pay.bills.description.clickable.text",
                                                             comment: "Word range that's clickable in pay bills description"),
                urlText: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.payment.info.gini.link",
            ...
            privacyPolicy: .init(
                text: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.payment.info.questions.answer.clickable.text",
                                                      comment: "Payment info answers clickable privacy policy"),
                urlText: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.payment.info.gini.privacypolicy.link",
                                                         comment: "Gini privacy policy link url")),
            faq: .init(
                titleText: NSLocalizedStringPreferredFormat("gini.health.paymentcomponent.payment.info.questions.title.label",
