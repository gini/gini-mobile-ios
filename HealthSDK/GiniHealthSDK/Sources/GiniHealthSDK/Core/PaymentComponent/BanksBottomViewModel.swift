...
final class BanksBottomViewModel {
    ...
    let selectBankTitleText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.selectBank.label", 
    ...
    let descriptionText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentproviderslist.description", 
