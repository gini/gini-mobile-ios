...
final class InstallAppBottomViewModel {
    ...
    var titleText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.installAppBottomSheet.title",
    ...
    var moreInformationLabelText: String {
        isBankInstalled ? 
        GiniLocalized.customLocalization("ginihealth.paymentcomponent.installAppBottomSheet.tip.description",
                                         comment: "Text for tip information label").replacingOccurrences(of: bankToReplaceString,
                                                                                                         with: selectedPaymentProvider?.name ?? "") :
        GiniLocalized.customLocalization("ginihealth.paymentcomponent.installAppBottomSheet.notes.description",
    ...
    // Pay invoice label
    let continueLabelText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.installAppBottomSheet.continue.button.text",
