...
final class InstallAppBottomViewModel {
    ...
    var titleText: String = GiniLocalized.string("ginihealth.paymentcomponent.installAppBottomSheet.title",
    ...
    var moreInformationLabelText: String {
        isBankInstalled ? 
        GiniLocalized.string("ginihealth.paymentcomponent.installAppBottomSheet.tip.description",
                                         comment: "Text for tip information label").replacingOccurrences(of: bankToReplaceString,
                                                                                                         with: selectedPaymentProvider?.name ?? "") :
        GiniLocalized.string("ginihealth.paymentcomponent.installAppBottomSheet.notes.description",
    ...
    // Pay invoice label
    let continueLabelText: String = GiniLocalized.string("ginihealth.paymentcomponent.installAppBottomSheet.continue.button.text",
