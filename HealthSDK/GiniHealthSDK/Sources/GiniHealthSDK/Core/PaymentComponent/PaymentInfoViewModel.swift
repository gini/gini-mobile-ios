...
final class PaymentInfoViewModel {
    ...
    let titleText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.title.label", 
                                                             comment: "Payment Info title label text")
    
    let payBillsTitleText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.payBills.title.label", 
    ...
    private let payBillsDescriptionText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.payBills.description.label",
    ...
    private let payBillsDescriptionTextColor: UIColor = GiniColor(lightModeColor: UIColor.GiniHealthColors.dark1,
                                                                  darkModeColor: UIColor.GiniHealthColors.light1).uiColor()
    private let giniWebsiteText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.payBills.description.clickable.text",
                                                                   comment: "Word range that's clickable in pay bills description")
    private let giniFont: UIFont
    private let giniURLText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.gini.link", 
                                                               comment: "Gini website link url")
    
    let questionsTitleText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.questions.title.label",
    ...
    private let answerPrivacyPolicyText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.questions.answer.clickable.text",
                                                                           comment: "Payment info answers clickable privacy policy")
    private let privacyPolicyURLText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.gini.privacypolicy.link",
    ...
    private func setupQuestions() {
        for index in 1 ... Constants.numberOfQuestions {
            let answerAttributedString = answerWithAttributes(answer: GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.questions.answer.\(index)",
                                                                                                       comment: "Answers description"))
            let questionSection = FAQSection(title: GiniLocalized.customLocalization("ginihealth.paymentcomponent.paymentinfo.questions.question.\(index)",
