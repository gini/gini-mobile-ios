...
final class PaymentComponentViewModel {
    ...
    let moreInformationLabelText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.moreInformation.label", 
                                                                    comment: "Text for more information label")
    let moreInformationActionablePartText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.moreInformation.underlined.part",
    ...
    // Select bank label
    let selectYourBankLabelText = GiniLocalized.customLocalization("ginihealth.paymentcomponent.selectYourBank.label", 
    ...
    let notInstalledBankTextColor: UIColor = GiniColor(lightModeColor: UIColor.GiniHealthColors.dark4,
                                                       darkModeColor: UIColor.GiniHealthColors.light4).uiColor()
    let placeholderBankNameText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.selectBank.label",
    ...
    // Pay invoice label
    let payInvoiceLabelText: String = GiniLocalized.customLocalization("ginihealth.paymentcomponent.payInvoice.label", 
