...
For the [To the banking app button label](https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12909-11275&t=aHxsiaVHNdae2b9i-0) in the Payment Review screen we use `gini.health.paymentcomponent.to.banking.app.label`. 
...
You can also view the UI customisation guide in Figma [here](https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12906-23094&t=aHxsiaVHNdae2b9i-0).
...
<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12906-23094&t=aHxsiaVHNdae2b9i-4" allowfullscreen></iframe>

## Bank Selection Bottom Sheet

You can also view the UI customisation guide in Figma [here](https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-10274&t=aHxsiaVHNdae2b9i-4).

**Note:**
To copy text from Figma you need to have a Figma account. If you don't have one, you can create one for free.

<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-10274&t=aHxsiaVHNdae2b9i-4" allowfullscreen></iframe>

## Payment Feature Info Screen

You can also view the UI customisation guide in Figma [here](https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-11429&t=aHxsiaVHNdae2b9i-4).

**Note:**
To copy text from Figma you need to have a Figma account. If you don't have one, you can create one for free.

<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-11429&t=aHxsiaVHNdae2b9i-4" allowfullscreen></iframe>

## Payment Review screen
 
You can also view the UI customisation guide in Figma [here](https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-12507&t=aHxsiaVHNdae2b9i-4).

**Note:**
To copy text from Figma you need to have a Figma account. If you don't have one, you can create one for free.

<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/design/vkZ0H0OA2K31DzgHrl5zRy/iOS-Gini-Health-SDK-5.5.0-UI-Customization?node-id=12907-12507&t=aHxsiaVHNdae2b9i-4" allowfullscreen></iframe>
