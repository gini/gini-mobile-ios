...
class TransferSummaryIntegrationTest: XCTestCase {
    ...
    override func setUp() {
        ...
        transferSummarySendingGroup = DispatchGroup()
    }
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 10, execute: {
                    ...
                    self.integrationTest.getUpdatedExtractionsFromGiniCaptureSDK(for: result.document!) { result in
                        ...
                        case let .success(extractionResult):
                            ...
                            XCTAssertNil(GiniConfiguration.shared.documentService)
                            self.expect.fulfill()
            ...
            case .success(_):
                ...
                self.giniCaptureSDKDocumentService?.startAnalysis { result in
                    ...
                    case let .success(extractionResult):
                        ...
                        GiniConfiguration.shared.sendTransferSummary(paymentRecipient: extractions["paymentRecipient"]?.value ?? "",
