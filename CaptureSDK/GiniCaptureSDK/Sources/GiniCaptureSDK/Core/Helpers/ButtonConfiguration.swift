...
public extension UIButton {
    func configure(with configuration: ButtonConfiguration) {
        ...
        // When switching from one ButtonConfiguration with a blur effect to another ButtonConfiguration with a blur effect, // the previous blur effect should be removed.
