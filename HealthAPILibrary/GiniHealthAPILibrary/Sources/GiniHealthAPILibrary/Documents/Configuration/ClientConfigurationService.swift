...
public final class ClientConfigurationService: ClientConfigurationServiceProtocol {
    /**
     ...
     - Parameter completion: A closure to be called upon completion of the fetch operation. The closure takes a `CompletionResult<ClientConfiguration>` as its parameter.
